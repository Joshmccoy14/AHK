...
loop, %loop%
{
    ...
    ;click cut crystals in inventory
        ImageSearch, foundX, foundY, 1, 1, 1365, 759,*20 C:\Users\josh\Desktop\New folder\cutruby.png
        If errorlevel = 0 
        {
            varxpos := foundX + 10
            varypos := foundY + 10
    ...
    loop
    {
        ImageSearch, foundX, foundY, 1, 1, 1365, 759,*20 C:\Users\josh\Desktop\New folder\bankuncutruby.png
            Random, r, 250,350
            sleep, %r%
    }
    until errorlevel = 0 
    ...
    ;click uncut ruby
            ...
            ImageSearch, foundX, foundY, 1, 1, 1365, 759,*20 C:\Users\josh\Desktop\New folder\uncutruby.png
            sleep 55
            if errorlevel = 0 
                varxpos := foundX + 13
                varypos := foundY + 10
    ...
    loop
        {
            ImageSearch, foundX, foundY, 1, 1, 1365, 759,*20 C:\Users\josh\Desktop\New folder\confirmcutruby.png
            sleep 55
        }
            until errorlevel = 0 
                varxpos := foundX + 38
