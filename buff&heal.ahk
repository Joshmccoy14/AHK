...
confirm:="|<>**50$109."
...
LaunchSelected:
  ...
  for index, charNum in selectedChars {
    ...
    ; Wait for client to launch, then skip intro
    Sleep, 3000
    Loop, 7 {
      Send, {Escape}
      Sleep, 100
    ...
    Loop {
      if (FindText(0, 0, A_ScreenWidth, A_ScreenHeight, 0, 0, iD)) {
        result := FindText(0, 0, A_ScreenWidth, A_ScreenHeight, 0, 0, iD)
    ...
    confirmCount := 0
    Loop {
      if (FindText(0, 0, A_ScreenWidth, A_ScreenHeight, 0, 0, confirm)) {
        Send, {Enter}
        confirmCount := 0
      } else {
        confirmCount++
